...
print("Object_2 first: ", object_2._ObjCounter__first) # type: ignore
print("Object_3 first: ", object_3._ObjCounter__first) # type: ignore
print("We have created:", end=" ")
print(object_3._ObjCounter__counter, "objects") #type: ignore
